...
#ifndef _VM_OBJECT_UNDEF_H_
#define _VM_OBJECT_UNDEF_H_

#include <stdint.h>

struct virtual_machine_object;

struct virtual_machine_object_undef
{
    int dummy; /* currently not necessary */
};

struct virtual_machine_object *virtual_machine_object_undef_new( \
...
/* eq, ne */
int virtual_machine_object_undef_binary( \
        struct virtual_machine *vm, \
